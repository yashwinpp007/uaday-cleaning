...
const faqs = [
  { category: 'General', question: 'Are you fully insured?', answer: 'Yes. UDAY Cleaning carries full public liability insurance. All team members are police-checked and insured. We can provide copies of certificates on request. Learn more on our <a href="/about" class="text-brand-green underline">About page</a>.', link: '/about' },
  { category: 'General', question: 'What areas do you service?', answer: 'We service Deanside and surrounding suburbs including Truganina, Hoppers Crossing, Werribee, Tarneit, Point Cook, Laverton, Altona Meadows, Williams Landing, and more. See our <a href="/service-areas" class="text-brand-green underline">Service Areas page</a> for the full list.', link: '/service-areas' },
  ...
  { category: 'Booking', question: 'Can I book a same-day clean?', answer: 'Yes, subject to availability. Call us early in the morning on 0420 203 336 to check same-day availability. We do our best to accommodate urgent requests.', link: null },
    ...
    <>
      ...
      <section className="pt-40 pb-16 bg-gradient-to-br from-brand-green-light to-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-body-text text-xl mb-8">Everything you need to know about UDAY Cleaning services.</p>
