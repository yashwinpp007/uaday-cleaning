...
export const metadata: Metadata = {
  title: 'Cleaning Services Across West Melbourne | UaDay Cleaning',
  description:
    'Professional cleaning services in Truganina, Hoppers Crossing, Werribee, Tarneit, Point Cook, Laverton and more. Servicing all of West Melbourne.',
    ...
    <>
      <section className="pt-32 pb-16 bg-gradient-to-br from-brand-green-light to-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h1 className="font-heading font-900 text-dark-text text-5xl md:text-6xl mb-5">
            Cleaning Services Across West Melbourne
          </h1>
          <p className="text-body-text text-xl max-w-2xl mx-auto mb-8">
            We service West Melbourne and all surrounding suburbs. Professional residential, commercial and end of lease cleaning wherever you are.
          </p>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-3xl mx-auto px-4">
          <h2 className="font-heading font-900 text-dark-text text-2xl mb-4">Professional Cleaning Across West Melbourne</h2>
          <div className="text-body-text leading-relaxed space-y-4">
            <p>UaDay Cleaning provides professional residential, commercial, and end of lease cleaning services throughout West Melbourne and the Western suburbs of Melbourne, Victoria.</p>
